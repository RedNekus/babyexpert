<?php
        ...
        $mcImageManagerConfig['filesystem.path'] = $_SERVER['DOCUMENT_ROOT'].'/assets/images/'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = $_SERVER['DOCUMENT_ROOT'].'/assets/images/'; // absolute or relative from this script path, required.
        ...
        // Upload options
        $mcImageManagerConfig['upload.maxsize'] = get_upload_max_file_size();
        ...
        $mcImageManagerConfig['SessionAuthenticator.logged_in_key'] = "isLoggedInFm";
        $mcImageManagerConfig['SessionAuthenticator.groups_key'] = "groups";
        $mcImageManagerConfig['SessionAuthenticator.user_key'] = "userFm";

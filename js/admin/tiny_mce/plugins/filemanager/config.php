<?php
        ...
        require_once($_SERVER['DOCUMENT_ROOT'].'/system/library/functions.php');
        // * * * * FileManager config
        ...
        $mcFileManagerConfig['filesystem.path'] = $_SERVER['DOCUMENT_ROOT'].'/assets/'; // absolute or relative from this script path.
        $mcFileManagerConfig['filesystem.rootpath'] = $_SERVER['DOCUMENT_ROOT'].'/assets/'; // absolute or relative from this script path.
        ...
        $mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,png,swf,dcr,mov,qt,ram,rm,avi,mp3,mpg,mpeg,asf,flv,doc,docx";
        ...
        // Upload options
        $mcFileManagerConfig['upload.maxsize'] = get_upload_max_file_size();
        ...
        $mcFileManagerConfig['SessionAuthenticator.logged_in_key'] = "isLoggedInFm";
        $mcFileManagerConfig['SessionAuthenticator.groups_key'] = "groups";
        $mcFileManagerConfig['SessionAuthenticator.user_key'] = "userFm";

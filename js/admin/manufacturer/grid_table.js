$(document).ready(function() {
	var baseUrl			= "/adminpanel/manufacturer/";
	...
	table.jqGrid({
		...
		autowidth: true,
		height: height,		
        colNames:['Код','Название','Адрес','Контакты','Активен'],
        colModel :[
            ...
            {name:'adres',		index:'adres', 		width:150, 	align:'left',	 	search:true, 	editable:true, 	edittype:"text" },
			{name:'contact', 	index:'contact', 	width:150, 	align:'left', 		search:true, 	editable:true, 	edittype:"text" },
			{name:'active', 	index:'active', 	width:50, 	align:'left', 		search:false, 	editable:true, 	edittype:"text" },
			],
        pager: pager,
        sortname: 'id',
		toolbar: [true,"top"],

$(document).ready(function() {
	...
	table.jqGrid({
        ...
        colModel :[
            {name:'fio', 		index:'fio', 		width:250, 	align:'left', 		search:true, 	editable:true, 	edittype:"text" },
            {name:'login',		index:'login', 		width:250, 	align:'left',	 	search:true, 	editable:true, 	edittype:"text" },
			{name:'email', 		index:'email', 		width:250, 	align:'left', 		search:true, 	editable:true, 	edittype:"text" },

<script type="text/javascript" src="/js/admin/article/grid_article.js"></script>
	...
	<!-- Вкладка общие !-->				
					...
					<table class="table-tabs-content">
						<tbody>												
							...
							<tr>
								<td> Дата: </td>				
								<td><input type="text" class="admin-datepicker" name="timestamp" id="val_timestamp" />	</td>
							</tr>							
							<tr>
								<td> Путь:</td>				
							...
							<tr>
								<td> Изображение:</td>				
								<td><input type="file" name="image" size="105" id="valueAkcii_file"/></td>
							</tr>
							<tr>
								<td> &nbsp;</td>	
								<td> 

<script type="text/javascript" src="/js/admin/maker/grid_table.js"></script>
	...
	<!-- Вкладка общие !-->				
					...
					<table class="table-tabs-content">
						<tbody>												
							...
							<tr>
								<td> Страна:</td>				
								<td><input type="text" name="country" id="val_country" /></td>
							</tr>	
							<tr>
								<td> Страна: <img class="blr" src="/img/admin/icons/blr.png" alt=""/></td>				
								<td><input type="text" name="country_lng" id="val_country_lng" /></td>
							</tr>
							<tr>
								<td> Изготовитель:</td>	
								<td>
									<select name="id_manufacturer" id="val_id_manufacturer">
							...
							<tr>
								<td> Импортер:</td>	
								<td>
									<select name="id_importer" id="val_id_importer">
										<option value="0">-- Выберите --</option>
										<?php foreach ($importer as $item): ?>														
											<option value="<?php echo $item['id']; ?>"><?php echo $item['name']; ?></option>
										<?php endforeach; ?>
									</select>
								</td>

<script type="text/javascript" src="/js/admin/zakaz/grid_predzakaz.js"></script>
		...
		<div id="tovarForm">
			<form action="" id="form_tovar">
				...
				<input type="hidden" name="action" id="action_tovar" />	
					...
					<tr>
						<td> Обработан:</td>		
						<td colspan=3><input type="checkbox" name="active_predzakaz" id="value_active_predzakaz" /></td>
					</tr>						
					<tr>
						<td> &nbsp;</td>

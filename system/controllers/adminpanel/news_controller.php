...
class News_Controller {
	...
	public function __construct() {
		$this->_config = Config::getParam('modules->news');
		$this->_table = get_table('news');
		$this->_table_lng = get_table_lng('news');		
		$this->_content['title'] = 'Новости сайта';
	}

	public function defaultAction() {
	
		$this->_content['content'] = Render::view('adminpanel/news/list');
